    ...
    return (
        <div className="fixed inset-0 bg-[#101010] flex flex-col items-center justify-center gap-4 p-4">
            <div className="relative h-28 w-28">
                <div className="loading-swirl absolute inset-0 rounded-full" aria-hidden="true" />
            ...
            <style>{`
              ...
              .loading-swirl {
                background: radial-gradient(circle at 30% 30%, rgba(255, 209, 221, 0.7), rgba(203, 151, 165, 0.25) 45%, rgba(16, 16, 16, 0) 70%);
