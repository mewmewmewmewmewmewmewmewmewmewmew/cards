  ...
  return (
    <div className="fixed inset-0 bg-[#101010] flex flex-col items-center justify-center gap-4 p-4">
      ...
      <div className="absolute bottom-1/4 flex gap-8">
        <a href="https://mew.cards/gg" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1.5 opacity-50 hover:opacity-90 transition-opacity duration-200">
          <img src="https://mew.cards/gg/img/logo.png" alt="Grading Guard Visualizer" className="h-[60px] w-[60px] object-contain" />
          <span className="text-[9px] text-gray-400">Grading Guard</span>
        </a>
        <a href="https://centering.mew.cards" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1.5 opacity-50 hover:opacity-90 transition-opacity duration-200">
